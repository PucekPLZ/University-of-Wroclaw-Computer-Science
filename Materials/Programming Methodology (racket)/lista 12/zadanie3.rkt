...
; W 1. p, czyli lambda(x) (+ x a) oznacza lambda(x) (+ x 10), a jest nadpisywane w trzecim let.
; W 2. p, czyli lambda(x) (+ x a) oznacza lambda(x) (+ x 1), a nie jest nadpisywane przez dalsze wystąpienia.
